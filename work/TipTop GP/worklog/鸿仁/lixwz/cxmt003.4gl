...
DEFINE l_tc_oeu04_t LIKE tc_oeu_file.tc_oeu04   #add by lixwz 170808
...
DEFINE l_ta_oeb04_t   STRING  # add by lixwz 20170808
...
#------订单宽
       ...
       #  END  IF
         ...
         #----客户类
         SELECT occ19 INTO l_occ19 FROM occ_file WHERE occ02=l_ta_oea.oea03
         IF cl_null(l_occ19) THEN
         ...
         FOREACH l_cur4 INTO l_oen.*,l_tc_oen08
            ...
            LET l_ta_oeb04_t=l_oen.oen03                                                   # add by lixwz 20170808
            ...
            IF l_ta_oeb.ta_oeb23 = 'Y'  AND l_ta_oeb.ta_oeb18 != 'N' THEN
                  IF l_tc_oen08 ='Y' THEN
                        IF l_ta_oeb.ta_oeb06 >0 OR l_ta_oeb.ta_oeb07>0 THEN            #add by zl 170429  2 on 1 簾取用左右簾的寬度 -begin-
                             SELECT tc_oeu04 INTO l_tc_oeu04_t FROM tc_oeu_file,tc_oeo_file
                               WHERE tc_oeu01 = tc_oeo01 AND tc_oeo03 = l_ta_oeb.ta_oeb18
                                 AND tc_oeu02 <l_ta_oeb.ta_oeb06 AND tc_oeu03 >=l_ta_oeb.ta_oeb06
                       ELSE                                                           #add by zl 170429  2 on 1 簾取用左右簾的寬度 -end-
                            SELECT tc_oeu04 INTO l_tc_oeu04_t FROM tc_oeu_file,tc_oeo_file
                               WHERE tc_oeu01 = tc_oeo01 AND tc_oeo03 = l_ta_oeb.ta_oeb18
